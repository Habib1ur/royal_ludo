        ...
        <section className="max-w-2xl">
          ...
          <div className="mt-8 rounded-[2rem] border border-white/15 bg-white/10 p-5 shadow-glass backdrop-blur-xl">
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <button type="button" onClick={() => onOptionsChange({ fastMode: !options.fastMode })} className={`rounded-[1.3rem] border px-4 py-4 text-left transition ${options.fastMode ? 'border-white/30 bg-white/15' : 'border-white/10 bg-white/5'}`}>
                <p className="text-sm font-semibold text-white">Fast mode</p>
                <p className="mt-1 text-sm text-slate-300">Shorter dice and move delays.</p>
              </button>
